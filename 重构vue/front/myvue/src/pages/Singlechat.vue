...
export default {
  ...
  data() {
    return {
      sidebarOpen: true,
      users: [],
      defaultAvatar: "https://ae88-2001-250-4001-208-addd-61f-1192-be83.ngrok-free.app/public/img/default.png",
      activeChatUser: null,
      messages: [],
      inputMsg: "",
      currentUser: null,
  ...
  methods: {
    ...
    initSocket() {
      this.socket = io('https://ae88-2001-250-4001-208-addd-61f-1192-be83.ngrok-free.app', {
    ...
    async loadUserList() {
      try {
        const ngrokAxios = this.createNgrokAxios();
        const res = await ngrokAxios.get('https://ae88-2001-250-4001-208-addd-61f-1192-be83.ngrok-free.app/api/user/list');
    ...
    async openChat(user) {
      ...
      try {
        const ngrokAxios = this.createNgrokAxios();
        const res = await ngrokAxios.get('https://ae88-2001-250-4001-208-addd-61f-1192-be83.ngrok-free.app/api/message/history', {
          params: { 
            to: user._id,
    ...
    async sendMessage() {
      ...
      try {
        // 1. 保存到数据库
        const ngrokAxios = this.createNgrokAxios();
        const res = await ngrokAxios.post('https://ae88-2001-250-4001-208-addd-61f-1192-be83.ngrok-free.app/api/message/send', {
